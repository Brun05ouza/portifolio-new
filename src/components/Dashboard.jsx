...
const Dashboard = () => {
  ...
  const cards = [
    { title: 'Visitantes', value: analytics.visitors, color: 'bg-blue-500', icon: '👥' },
    { title: 'Page Views', value: analytics.pageViews, color: 'bg-green-500', icon: '📊' },
    { title: 'Bounce Rate', value: `${analytics.bounceRate.toFixed(1)}%`, color: 'bg-yellow-500', icon: '⚡' },
    { title: 'Tempo Médio', value: `${analytics.avgSessionTime.toFixed(0)}s`, color: 'bg-purple-500', icon: '⏱️' }
  ];
